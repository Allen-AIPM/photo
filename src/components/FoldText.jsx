...
const FoldText = ({
  ...
  useEffect(() => {
    ...
    if (trigger === 'hover') {
      ...
      scrollTrigger = new IntersectionObserver(entries=>{if(entries.some(e=>e.isIntersecting)){play(false);scrollTrigger.disconnect()}},{rootMargin:'0px 0px -18% 0px'});
      scrollTrigger.observe(root);
